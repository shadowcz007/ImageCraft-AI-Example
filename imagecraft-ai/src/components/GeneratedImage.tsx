  ...
  return (
    <>
      ...
      <div className="flex w-full grow bg-[#f8fcfa] @container p-4">
        <div className="w-full gap-1 overflow-hidden bg-[#f8fcfa] @[480px]:gap-2 aspect-[3/2] rounded-lg flex">
          <div
      ...
      <div className="@container">
        <div className="gap-2 px-4 flex flex-wrap justify-start">
          <div className="flex flex-col items-center gap-2 bg-[#f8fcfa] py-2.5 text-center w-20">
            <div className="rounded-full bg-[#e6f4ef] p-2.5">
            ...
            <p className="text-[#0c1c17] text-sm font-medium leading-normal">Download</p>
          </div>
          <div className="flex flex-col items-center gap-2 bg-[#f8fcfa] py-2.5 text-center w-20">
            <div className="rounded-full bg-[#e6f4ef] p-2.5">
              <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill="currentColor" viewBox="0 0 256 256">
            ...
            <p className="text-[#0c1c17] text-sm font-medium leading-normal">Add Text</p>
          </div>
          <div className="flex flex-col items-center gap-2 bg-[#f8fcfa] py-2.5 text-center w-20">
            <div className="rounded-full bg-[#e6f4ef] p-2.5">
              <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill="currentColor" viewBox="0 0 256 256">
            ...
            <p className="text-[#0c1c17] text-sm font-medium leading-normal">Watermark</p>
          </div>
          <div className="flex flex-col items-center gap-2 bg-[#f8fcfa] py-2.5 text-center w-20">
            <div className="rounded-full bg-[#e6f4ef] p-2.5">
              <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill="currentColor" viewBox="0 0 256 256">
            ...
            <p className="text-[#0c1c17] text-sm font-medium leading-normal">Enhance</p>
          </div>
          <div className="flex flex-col items-center gap-2 bg-[#f8fcfa] py-2.5 text-center w-20">
            <div className="rounded-full bg-[#e6f4ef] p-2.5">
              <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill="currentColor" viewBox="0 0 256 256">
            ...
            <p className="text-[#0c1c17] text-sm font-medium leading-normal">Share</p>
          </div>
        </div>
      </div>
    </>
