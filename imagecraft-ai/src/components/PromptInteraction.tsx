    ...
    <>
      ...
      <div className="flex items-end gap-3 p-4">
        ...
        <div className="flex flex-1 flex-col gap-1 items-start">
          <p className="text-[#46a080] text-[13px] font-normal leading-normal max-w-[360px]">
            AI Assistant
          </p>
          <p className="text-base font-normal leading-normal flex max-w-[360px] rounded-lg px-4 py-3 bg-[#e6f4ef] text-[#0c1c17]">
        ...
        <div className="flex flex-col min-w-40 h-12 flex-1">
          <div className="flex w-full flex-1 items-stretch rounded-lg h-full">
            <Input
              ...
              className="flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-[#0c1c17] focus:outline-0 focus:ring-0 border-none bg-[#e6f4ef] focus:border-none h-full placeholder:text-[#46a080] px-4 rounded-r-none border-r-0 pr-2 text-base font-normal leading-normal"
              value={prompt}
              onChange={(e) => setPrompt(e.target.value)}
              onKeyPress={handleKeyPress}
            />
            <div className="flex border-none bg-[#e6f4ef] items-center justify-center pr-4 rounded-r-lg border-l-0 !pr-2">
              <div className="flex items-center gap-4 justify-end">
                <div className="flex items-center gap-1">
                  <Button 
                    variant="ghost" 
                    size="sm"
                    className="flex items-center justify-center p-1.5 text-[#46a080] hover:bg-[#d1e8e0]"
                  >
                ...
                <Button
                  className="min-w-[84px] max-w-[480px] h-8 px-4 bg-[#019863] text-[#f8fcfa] text-sm font-medium leading-normal hidden @[480px]:block hover:bg-[#017a4f]"
                  onClick={onSend}
                >
                  Send
                </Button>
